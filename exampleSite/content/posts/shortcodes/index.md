...
sequenceDiagram
    participant Alice
    participant Bob
    Alice->>Mayur: Hello Mayur, how are you?
    loop Healthcheck
        Mayur->>Mayur: Fight against hypochondria
    end
    Note right of Mayur: Rational thoughts <br/>prevail!
    Mayur-->>Alice: Great!
    Mayur->>Bob: How about you?
    Bob-->>Mayur: Jolly good!
{{< /mermaid >}}
